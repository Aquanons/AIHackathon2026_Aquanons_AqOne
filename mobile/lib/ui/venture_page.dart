...
class _VenturePageState extends State<VenturePage> {
        ...
        child: Row(
          children: <Widget>[
            Container(
              ...
              height: 38,
              decoration: BoxDecoration(
                color: Colors.amber.withValues(alpha: isDark ? 0.20 : 0.16),
                shape: BoxShape.circle,
              ),
              child: Icon(
                icon,
  ...
  Widget _buildSosStatus(bool isDark, SosRecord record) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: (isDark ? _canvasDark : Colors.white).withValues(alpha: 0.94),
      ...
      child: Row(
        ...
        children: <Widget>[
          Container(
            ...
            child: Icon(stateIcon, size: 15, color: color),
          ),
