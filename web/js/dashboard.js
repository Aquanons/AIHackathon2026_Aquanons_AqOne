(function (ns) {
  ...
  var emergencyOverlay = ns.emergencyOverlay;
  var emergencyClose = ns.emergencyClose;
  var emergencyBtn = ns.emergencyBtn;
  var openEmergencyModal = ns.openEmergencyModal;
  var closeEmergencyModal = ns.closeEmergencyModal;
  var advisoryPanelClose = ns.advisoryPanelClose;
  var advisoryListEl = ns.advisoryListEl;
  var btnCreateAdvisory = ns.btnCreateAdvisory;
  var advisoryOverlay = ns.advisoryOverlay;
  var advisoryModalClose = ns.advisoryModalClose;
  var advBtnCancel = ns.advBtnCancel;
  var advBtnSave = ns.advBtnSave;
  var advisoryModalTitle = ns.advisoryModalTitle;
  var advTitleInput = ns.advTitleInput;
  var advCategorySelect = ns.advCategorySelect;
  var advDescriptionInput = ns.advDescriptionInput;
  var advMunicipalitySelect = ns.advMunicipalitySelect;
  var advPrioritySelect = ns.advPrioritySelect;
  var advPublishDateInput = ns.advPublishDateInput;
  var advExpirationDateInput = ns.advExpirationDateInput;
  var advCoverImageInput = ns.advCoverImageInput;
  var advStatusSelect = ns.advStatusSelect;
  var advTitleError = ns.advTitleError;
  var advDescriptionError = ns.advDescriptionError;
  var advMunicipalityError = ns.advMunicipalityError;
  var deleteOverlay = ns.deleteOverlay;
  var deleteClose = ns.deleteClose;
  var deleteCancelBtn = ns.deleteCancelBtn;
  var deleteConfirmBtn = ns.deleteConfirmBtn;
  var deleteNameEl = ns.deleteNameEl;
  var editingAdvisoryId = ns.editingAdvisoryId;
  var deletingAdvisoryId = ns.deletingAdvisoryId;
  var clearAdvisoryErrors = ns.clearAdvisoryErrors;
  var validateAdvisoryForm = ns.validateAdvisoryForm;
  var resetAdvisoryForm = ns.resetAdvisoryForm;
  var openAdvisoryModal = ns.openAdvisoryModal;
  var closeAdvisoryModal = ns.closeAdvisoryModal;
  var renderAdvisoryList = ns.renderAdvisoryList;
  var _escHtml = ns._escHtml;
  var closeDeleteModal = ns.closeDeleteModal;
  var seaConditionCurrent = ns.seaConditionCurrent;
  var seaConditionSetBtn = ns.seaConditionSetBtn;
  var seaConditionReason = ns.seaConditionReason;
  var seaConditionSelectedStatus = ns.seaConditionSelectedStatus;
  var SEA_STATUS_COLORS = ns.SEA_STATUS_COLORS;
  var formatSeaConditionTime = ns.formatSeaConditionTime;
  var fetchSeaCondition = ns.fetchSeaCondition;
  var renderSeaCondition = ns.renderSeaCondition;
